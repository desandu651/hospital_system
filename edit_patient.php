...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($name)) {
        ...
        $update_stmt = $conn->prepare("UPDATE patients SET name = ?, age = ?, gender = ?, phone = ?, address = ? WHERE id = ?");
        $update_stmt->bind_param("sisssi", $name, $age, $gender, $phone, $address, $id);
...
<head>
    ...
    <title>Edit Patient - Medi Lanka HMS</title>
    <!-- Google Fonts -->
...
<body>
    ...
    <div class="main-wrapper">
        ...
        <header class="top-navbar">
            <h5 class="fw-bold text-dark mb-0">Edit Patient Record</h5>
            <a href="manage_patients.php" class="btn btn-outline-secondary btn-sm px-3 rounded-pill fw-semibold">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="content-card">
                        <h4 class="fw-bold text-dark mb-3">Update Patient Information</h4>
                        <p class="text-secondary small mb-4">Modify the patient's details below and save changes.</p>
                        ...
                        <form method="POST" action="">
                            ...
                            <div class="d-flex justify-content-end gap-2">
                                <a href="manage_patients.php" class="btn btn-light border px-4 py-2 rounded-3">Cancel</a>
